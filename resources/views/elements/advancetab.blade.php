...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb-inner text-center">
                        <h2 class="title">Advance Tab</h2>
                        <ul class="page-list">
                            <li class="rbt-breadcrumb-item"><a href="#">Home</a></li>
                            <li>
                                <div class="icon-right"><i class="feather-chevron-right"></i></div>
                            </li>
                            <li class="rbt-breadcrumb-item active">Advance Tab</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb--60">
                <div class="col-lg-12">
                    <div class="section-title text-center">
                        <span class="subtitle bg-secondary-opacity">You can Customize All</span>
                        <h2 class="title">Advance Tab Style One.</h2>
                    </div>
                </div>
            </div>
            <div class="row g-5">
                    ...
                    <div class="advance-tab-button advance-tab-button-1">
                        <ul class="nav nav-tabs tab-button-list" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a href="#" class="nav-link tab-button" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" role="tab" aria-controls="home" aria-selected="false">
                                    <div class="tab">
                            ...
                            <li class="nav-item" role="presentation">
                                <a href="#" class="nav-link tab-button active" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" role="tab" aria-controls="profile" aria-selected="true">
                                    <div class="tab">
                ...
                <div class="col-lg-8 col-md-12 col-sm-12 col-12 order-1 order-lg-2">
                    <div class="tab-content">
                        <div class="tab-pane fade advance-tab-content-1" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <div class="thumbnail">
                                <img src="{{ asset('assets/images/tab/tabs-03.jpg') }}" alt="advance-tab-image">
                            </div>

                        </div>
                        <div class="tab-pane fade advance-tab-content-1 active show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            <div class="thumbnail">
        ...
        <div class="container">
            <div class="row mb--60">
                <div class="col-lg-12">
                    <div class="section-title text-center">
                        <span class="subtitle bg-secondary-opacity">You can Customize All</span>
                        <h2 class="title">Advance Tab Style Two.</h2>
                    </div>
                </div>
            </div>
            <div class="row g-5">
                <div class="col-lg-8 col-md-12 col-sm-12 col-12">
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade advance-tab-content-1" id="home-2" role="tabpanel" aria-labelledby="home-tab-2">
                            <div class="thumbnail">
                                <img src="{{ asset('assets/images/tab/tabs-04.jpg') }}" alt="advance-tab-image">
                            </div>
                        </div>
                        <div class="tab-pane fade advance-tab-content-1 active show" id="profile-2" role="tabpanel" aria-labelledby="profile-tab-2">
                            <div class="thumbnail">
                                <img src="{{ asset('assets/images/tab/tabs-05.jpg') }}" alt="advance-tab-image">
                            </div>
                        </div>
                        <div class="tab-pane fade advance-tab-content-1" id="contact-2" role="tabpanel" aria-labelledby="contact-tab-2">
                            <div class="thumbnail">
                                <img src="{{ asset('assets/images/tab/tabs-06.jpg') }}" alt="advance-tab-image">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-12 col-sm-12 col-12 mt_md--30 mt_sm--30">
                    <div class="advance-tab-button advance-tab-button-1 right-align">
                        <ul class="nav nav-tabs tab-button-list" id="myTab-2" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a href="#" class="nav-link tab-button" id="home-tab-2" data-bs-toggle="tab" data-bs-target="#home-2" role="tab" aria-controls="home" aria-selected="false">
                                    <div class="tab">
                                        <h4 class="title">Market Researce.</h4>
                                        <p class="description">Use Doob template you can build a corporate
                                            website a short time.</p>
                            ...
                            <li class="nav-item" role="presentation">
                                <a href="#" class="nav-link tab-button active" id="profile-tab-2" data-bs-toggle="tab" data-bs-target="#profile-2" role="tab" aria-controls="profile-2" aria-selected="true">
                                    <div class="tab">
                                        <h4 class="title">Corporate Report.</h4>
                                        <p class="description">Use Doob template you can build a corporate
                                            website a short time.</p>
        ...
        <div class="container">
            <div class="row mb--60">
                <div class="col-lg-12">
                    <div class="section-title text-center">
                        <span class="subtitle bg-secondary-opacity">You can Customize All</span>
                        <h2 class="title">Advance Tab Style Three.</h2>
                    </div>
                </div>
            </div>
            <div class="row g-5">
                <div class="col-lg-10 offset-lg-1">
                    <div class="tab-content">
                        <div class="tab-pane fade advance-tab-content-1 right-top" id="home-3" role="tabpanel" aria-labelledby="home-tab-3">
                            <div class="thumbnail">
                                <img class="w-100" src="{{ asset('assets/images/tab/tabs-07.jpg') }}" alt="advance-tab-image">
                            </div>
                        </div>
                        <div class="tab-pane fade advance-tab-content-1 active show" id="profile-3" role="tabpanel" aria-labelledby="profile-tab-3">
                            <div class="thumbnail">
                                <img class="w-100" src="{{ asset('assets/images/tab/tabs-08.jpg') }}" alt="advance-tab-image">
                            </div>
                        </div>
                        <div class="tab-pane fade advance-tab-content-1" id="contact-3" role="tabpanel" aria-labelledby="contact-tab-3">
                            <div class="thumbnail">
                                <img class="w-100" src="{{ asset('assets/images/tab/tabs-09.jpg') }}" alt="advance-tab-image">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="advance-tab-button advance-tab-button-1 right-top">
                        <ul class="nav nav-tabs tab-button-list" id="myTab-3" role="tablist">
                            ...
                            <li class="col-lg-4 nav-item" role="presentation">
                                <a href="#" class="nav-link tab-button" id="home-tab-3" data-bs-toggle="tab" data-bs-target="#home-3" role="tab" aria-controls="home" aria-selected="false">
                                    <div class="tab">
                                        <h4 class="title">Market Researce.</h4>
                                        <p class="description">Use Doob template you can build a corporate
                                            website a short time.</p>
                            ...
                            <li class="col-lg-4 nav-item" role="presentation">
                                <a href="#" class="nav-link tab-button active" id="profile-tab-3" data-bs-toggle="tab" data-bs-target="#profile-3" role="tab" aria-controls="profile-3" aria-selected="true">
                                    <div class="tab">
                                        <h4 class="title">Corporate Report.</h4>
                                        <p class="description">Use Doob template you can build a corporate
                                            website a short time.</p>
        ...
        <div class="container">
            <div class="row mb--40">
                <div class="col-lg-12">
                    <div class="section-title text-center">
                        <span class="subtitle bg-secondary-opacity">You can Customize All</span>
                        <h2 class="title">Advance Tab Style Four.</h2>
                    </div>
                </div>
            </div>
            <div class="row g-5">
                        ...
                        <ul class="nav nav-tabs tab-button-style-2" id="myTab-4" role="tablist">
                            ...
                            <li role="presentation">
                                <a href="#" class="tab-button" id="contact-tab-4" data-bs-toggle="tab" data-bs-target="#contact-4" role="tab" aria-controls="contact-4" aria-selected="false">
                                    <span class="title">Experiencing Music.</span>
                                </a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="row g-5 mt--40">
                <div class="col-lg-6">
                    <div class="rbt-category-gallery">
                        <div class="thumbnail">
                            <a href="#">
                                <img src="{{ asset('assets/images/gallery/gallery-01.jpg') }}" alt="Gallery Images">
                            </a>
    ...
    <div class="rbt-tab-area bg-color-white rbt-section-gap">
        <div class="container">
            <div class="row mb--40">
                <div class="col-lg-12">
                    <div class="section-title text-center sal-animate" data-sal="slide-up" data-sal-duration="700" data-sal-delay="100">
                        <span class="subtitle bg-secondary-opacity">You can Customize All</span>
                        <h2 class="title">Advance Tab Style Five.</h2>
                    </div>
                </div>
            </div>
            ...
            <div class="row row row--30 align-items-center">
                <div class="col-lg-5">
                    <img class="radius-small" src="{{ asset('assets/images/tab/tabs-02.jpg') }}" alt="Corporate Template">
                </div>
                    ...
                    <div class="rbt-default-tab">
                        <ul class="nav nav-tabs tab-button" role="tablist">
                            <li class="nav-item tabs__tab " role="presentation">
                                <button class="nav-link active" id="home-tab-5" data-bs-toggle="tab" data-bs-target="#home5" type="button" role="tab" aria-controls="home5" aria-selected="true">Strategy</button>
                            </li>
                            <li class="nav-item tabs__tab " role="presentation">
                                <button class="nav-link" id="profile-tab5" data-bs-toggle="tab" data-bs-target="#profile5" type="button" role="tab" aria-controls="profile5" aria-selected="false">Reporting</button>
                            </li>
                            <li class="nav-item tabs__tab " role="presentation">
                                <button class="nav-link" id="contact-tab5" data-bs-toggle="tab" data-bs-target="#contact5" type="button" role="tab" aria-controls="contact5" aria-selected="false">Development</button>
                            </li>
                        </ul>
                        <div class="rainbow-tab-content tab-content">
                            <div class="tab-pane fade show active" id="home5" role="tabpanel" aria-labelledby="home-tab-5">
