...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb-inner text-center">
                        <h2 class="title">List Style</h2>
                        <ul class="page-list">
                            <li class="rbt-breadcrumb-item"><a href="#">Home</a></li>
                            <li>
                                <div class="icon-right"><i class="feather-chevron-right"></i></div>
                            </li>
                            <li class="rbt-breadcrumb-item active">List Style</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="rbt-list-style-area bg-color-white rbt-section-gap">
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 col-md-12 col-12">
                    <ul class="rbt-list-style-1">
                        ...
                        <li><i class="feather-check"></i>Have an intermediate skill level of.</li>
                        <li><i class="feather-check"></i>Have a portfolio of various data.</li>
